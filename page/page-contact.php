  ...
  <body>
    ...
    <form method="post" action="receive.php">
     ...
     <fieldset>
         ...
         <input type="checkbox" id="opt1" name="client_choice" value="1"
                <label for="opt1">Par hasard</label><br>

          <input type="checkbox" id="opt2" name="client_choice" value="2"
                <label for="opt1">Par le bouche à oreille</label><br>

        <input type="checkbox" id="opt3" name="client_choice" value="3"
                <label for="opt1">Par les réseaux sociaux</label><br>

                <input type="checkbox" id="opt3" name="client_choice" value="stock20"
                        <label for="opt1">Par l'article d'une agence de presse</label>

        </fieldset>
<fieldset>
     <label for="addreq">Objet : </label> <br>
     <textarea name="com" id= "addreq" placeholder="Entrez ici vos demandes"> </textarea>
